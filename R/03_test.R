...
# Find matches for specific file format, after finishing this, using "#"
...
# error no tif file means that there will is no file providing terrain elevation information 
...
# Read MSOA centroids
centroids <- st_read('data/centroids/london_msoa_centroid2011.gpkg')
centroids <- st_transform(centroids, 4326)
centroids <- rename(centroids, id = MSOA11CD)
